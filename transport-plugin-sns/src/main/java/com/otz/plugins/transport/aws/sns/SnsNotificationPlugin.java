package com.otz.plugins.transport.aws.sns;
 ...
 */
@Service("PushNotificationPlugin")
public class SnsNotificationPlugin implements ExecutorPlugin {

    @Override
    public Topic topic() {
        return Topic.PUSH_NOTIFICATION;
    }
