...
import com.otz.transport.consumer.dispatcher.HipchatEventDispatcher;
 ...
 */
public class HtipchatNotificationRunnable extends AbstractEventRunnable {

    private final HipchatEventDispatcher dispatcher;
    private final KafkaConsumer consumer;


    public HtipchatNotificationRunnable(HipchatEventDispatcher dispatcher, Properties props, int interval) {
        ...
        consumer.subscribe(Collections.singletonList(Topic.HIPCHAT.getTopicName()));

        getDispatcher().dispatch(HipchatEventContent
                .create(null)
                .room("test")
                .users(null)
                .template("test")
