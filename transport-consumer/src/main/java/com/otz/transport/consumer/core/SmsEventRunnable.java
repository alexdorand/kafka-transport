...
import com.otz.transport.consumer.dispatcher.SmsEventDispatcher;
 ...
 */
public class SmsEventRunnable extends AbstractEventRunnable {

    private final SmsEventDispatcher dispatcher;
    private final KafkaConsumer consumer;


    public SmsEventRunnable(SmsEventDispatcher dispatcher, Properties props, int interval) {
        ...
        consumer.subscribe(Collections.singletonList(Topic.SMS.getTopicName()));
